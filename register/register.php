...
<head>
    ...
    <title>Daftar Akun - Spencal</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div style="margin-top: 20px; font-size: 0.9rem; color: var(--text-muted);">
                Sudah punya akun? <a href="../login/login.php" style="color: var(--primary); font-weight: 600;">Masuk disini</a>
            </div>
        </div>
    </div>
